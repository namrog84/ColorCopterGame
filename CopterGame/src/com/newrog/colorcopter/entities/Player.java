...
import com.newrog.coptergame.MyAudio;
...
public class Player extends Entity {
	...
	public Player(MainGame g) {
		...
		circle.setRadius(.17f);

		// Create a fixture definition to apply our shape to
		FixtureDef fixtureDef = new FixtureDef();
		fixtureDef.shape = circle;
		fixtureDef.density = 2.16f;//1.5625f; with radius .2
	...
	public void update(float delta) {
		...
		if (Gdx.input.isKeyPressed(Keys.UP) || Gdx.input.isKeyPressed(Keys.SPACE) || Gdx.input.isTouched()) {
